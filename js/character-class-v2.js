...
export default class Character {
  ...
  characterUpdate() {
    ...
    characterInfo.innerHTML = `<div id='character-stats'>
          <fieldset class='char-info-module'>
            <legend class='player-dashboard'>Player Data</legend>
              <h4 id='char-name' class='char-info-label'>Name: <span class="character-display-info">${finalCharacter.name
      }</span></h4>
        ...
        <div id="character-hitpoints">
          <fieldset class = "hitpoints-info-module-player hp-grid-container">
            ...
            <div class="hitpoints-guage">
              <div class="hitpoint-guage-value-current">${finalCharacter.specialty.healthPoints +
      finalCharacter.attributes[4].adjustment
      }</div>  
              <div class="hitpoint-guage-value-total">${finalCharacter.specialty.maxHealthPoints +
      finalCharacter.attributes[4].adjustment
      }</div>                            
            ...
            <div class="xp-guage">
              <div class="xp-guage-value-current">${finalCharacter.specialty.characterExperience
      }</div>  
    ...
    `;
/* ----UPDATE TO ONLY TARGET AFFECTED DOM ELEMENTS
